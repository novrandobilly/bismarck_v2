    ...
    return (
      <div className="min-h-screen bg-warm-cream flex items-center justify-center px-4">
        <div className="max-w-sm w-full text-center">
          ...
          <h1 className="font-serif text-xl font-bold text-ink-dark mb-2">
            Proof submitted!
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            >
              {file ? (
                <>
                  <p className="font-sans text-sm font-medium text-ink-dark">
                    {file.name}
                  </p>
                ...
                <>
                  ...
                  <p className="font-sans text-sm text-ink-medium">
